...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "8f35f542f899195ee65864b2ba8b929dc997ca61"
            ParseMutableClientConfiguration.clientKey = "2da0c1bca2f850dfa6be6a5f709bba67fe344865"
            ParseMutableClientConfiguration.server = "http://ec2-54-245-9-189.us-west-2.compute.amazonaws.com/parse"
        })
